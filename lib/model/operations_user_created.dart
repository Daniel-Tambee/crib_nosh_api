...
class OperationsUserCreated {
  /// Returns a new [OperationsUserCreated] instance.
  OperationsUserCreated({
    this.id,
    this.firstName,
    this.lastName,
    this.email,
  ...
  /// Status of the user.
  OperationsUserCreatedStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OperationsUserCreated &&
    other.id == id &&
  ...
  /// Returns a new [OperationsUserCreated] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OperationsUserCreated? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OperationsUserCreated[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OperationsUserCreated[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return OperationsUserCreated(
        ...
        status: OperationsUserCreatedStatusEnum.fromJson(json[r'status']),
  ...
  static List<OperationsUserCreated> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OperationsUserCreated>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OperationsUserCreated.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OperationsUserCreated> mapFromJson(dynamic json) {
    final map = <String, OperationsUserCreated>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OperationsUserCreated.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OperationsUserCreated-objects as value to a dart map
  static Map<String, List<OperationsUserCreated>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OperationsUserCreated>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OperationsUserCreated.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class OperationsUserCreatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const OperationsUserCreatedStatusEnum._(this.value);
  ...
  static const active = OperationsUserCreatedStatusEnum._(r'active');
  static const invited = OperationsUserCreatedStatusEnum._(r'invited');
  static const draft = OperationsUserCreatedStatusEnum._(r'draft');
  static const suspended = OperationsUserCreatedStatusEnum._(r'suspended');
  static const deleted = OperationsUserCreatedStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][OperationsUserCreatedStatusEnum].
  static const values = <OperationsUserCreatedStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static OperationsUserCreatedStatusEnum? fromJson(dynamic value) => OperationsUserCreatedStatusEnumTypeTransformer().decode(value);

  static List<OperationsUserCreatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OperationsUserCreatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OperationsUserCreatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [OperationsUserCreatedStatusEnum] to String,
/// and [decode] dynamic data back to [OperationsUserCreatedStatusEnum].
class OperationsUserCreatedStatusEnumTypeTransformer {
  factory OperationsUserCreatedStatusEnumTypeTransformer() => _instance ??= const OperationsUserCreatedStatusEnumTypeTransformer._();

  const OperationsUserCreatedStatusEnumTypeTransformer._();

  String encode(OperationsUserCreatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a OperationsUserCreatedStatusEnum.
  ///
  ...
  OperationsUserCreatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return OperationsUserCreatedStatusEnum.active;
        case r'invited': return OperationsUserCreatedStatusEnum.invited;
        case r'draft': return OperationsUserCreatedStatusEnum.draft;
        case r'suspended': return OperationsUserCreatedStatusEnum.suspended;
        case r'deleted': return OperationsUserCreatedStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [OperationsUserCreatedStatusEnumTypeTransformer] instance.
  static OperationsUserCreatedStatusEnumTypeTransformer? _instance;
}
