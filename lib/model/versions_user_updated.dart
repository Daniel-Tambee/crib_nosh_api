...
class VersionsUserUpdated {
  /// Returns a new [VersionsUserUpdated] instance.
  VersionsUserUpdated({
    this.id,
    this.firstName,
    this.lastName,
  ...
  /// Status of the user.
  VersionsUserUpdatedStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VersionsUserUpdated &&
    other.id == id &&
  ...
  /// Returns a new [VersionsUserUpdated] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static VersionsUserUpdated? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VersionsUserUpdated[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VersionsUserUpdated[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return VersionsUserUpdated(
        ...
        status: VersionsUserUpdatedStatusEnum.fromJson(json[r'status']),
  ...
  static List<VersionsUserUpdated> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <VersionsUserUpdated>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VersionsUserUpdated.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, VersionsUserUpdated> mapFromJson(dynamic json) {
    final map = <String, VersionsUserUpdated>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = VersionsUserUpdated.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of VersionsUserUpdated-objects as value to a dart map
  static Map<String, List<VersionsUserUpdated>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<VersionsUserUpdated>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = VersionsUserUpdated.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class VersionsUserUpdatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const VersionsUserUpdatedStatusEnum._(this.value);
  ...
  static const active = VersionsUserUpdatedStatusEnum._(r'active');
  static const invited = VersionsUserUpdatedStatusEnum._(r'invited');
  static const draft = VersionsUserUpdatedStatusEnum._(r'draft');
  static const suspended = VersionsUserUpdatedStatusEnum._(r'suspended');
  static const deleted = VersionsUserUpdatedStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][VersionsUserUpdatedStatusEnum].
  static const values = <VersionsUserUpdatedStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static VersionsUserUpdatedStatusEnum? fromJson(dynamic value) => VersionsUserUpdatedStatusEnumTypeTransformer().decode(value);

  static List<VersionsUserUpdatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <VersionsUserUpdatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VersionsUserUpdatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [VersionsUserUpdatedStatusEnum] to String,
/// and [decode] dynamic data back to [VersionsUserUpdatedStatusEnum].
class VersionsUserUpdatedStatusEnumTypeTransformer {
  factory VersionsUserUpdatedStatusEnumTypeTransformer() => _instance ??= const VersionsUserUpdatedStatusEnumTypeTransformer._();

  const VersionsUserUpdatedStatusEnumTypeTransformer._();

  String encode(VersionsUserUpdatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a VersionsUserUpdatedStatusEnum.
  ///
  ...
  VersionsUserUpdatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return VersionsUserUpdatedStatusEnum.active;
        case r'invited': return VersionsUserUpdatedStatusEnum.invited;
        case r'draft': return VersionsUserUpdatedStatusEnum.draft;
        case r'suspended': return VersionsUserUpdatedStatusEnum.suspended;
        case r'deleted': return VersionsUserUpdatedStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [VersionsUserUpdatedStatusEnumTypeTransformer] instance.
  static VersionsUserUpdatedStatusEnumTypeTransformer? _instance;
}
