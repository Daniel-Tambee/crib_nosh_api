...
class CreateRelationRequest {
  /// Returns a new [CreateRelationRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateRelationRequest &&
  ...
  @override
  String toString() => 'CreateRelationRequest[collectionMany=$collectionMany, collectionOne=$collectionOne, fieldMany=$fieldMany, fieldOne=$fieldOne, junctionField=$junctionField]';
  ...
  /// Returns a new [CreateRelationRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateRelationRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateRelationRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateRelationRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateRelationRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreateRelationRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateRelationRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateRelationRequest> mapFromJson(dynamic json) {
    final map = <String, CreateRelationRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateRelationRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CreateRelationRequest-objects as value to a dart map
  static Map<String, List<CreateRelationRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateRelationRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateRelationRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
