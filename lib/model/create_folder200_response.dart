...
class CreateFolder200Response {
  ...
  @override
  String toString() => 'CreateFolder200Response[data=$data]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateFolder200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateFolder200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CreateFolder200Response(
        data: Folders.fromJson(json[r'data']),
      );
    }
    return null;
  }
