...
class RolesUsersInner {
  /// Returns a new [RolesUsersInner] instance.
  RolesUsersInner({
    this.id,
    this.firstName,
    this.lastName,
  ...
  /// Status of the user.
  RolesUsersInnerStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RolesUsersInner &&
    other.id == id &&
  ...
  /// Returns a new [RolesUsersInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RolesUsersInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "RolesUsersInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "RolesUsersInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return RolesUsersInner(
        ...
        status: RolesUsersInnerStatusEnum.fromJson(json[r'status']),
  ...
  static List<RolesUsersInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RolesUsersInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RolesUsersInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RolesUsersInner> mapFromJson(dynamic json) {
    final map = <String, RolesUsersInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RolesUsersInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of RolesUsersInner-objects as value to a dart map
  static Map<String, List<RolesUsersInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<RolesUsersInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = RolesUsersInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class RolesUsersInnerStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const RolesUsersInnerStatusEnum._(this.value);
  ...
  static const active = RolesUsersInnerStatusEnum._(r'active');
  static const invited = RolesUsersInnerStatusEnum._(r'invited');
  static const draft = RolesUsersInnerStatusEnum._(r'draft');
  static const suspended = RolesUsersInnerStatusEnum._(r'suspended');
  static const deleted = RolesUsersInnerStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][RolesUsersInnerStatusEnum].
  static const values = <RolesUsersInnerStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static RolesUsersInnerStatusEnum? fromJson(dynamic value) => RolesUsersInnerStatusEnumTypeTransformer().decode(value);

  static List<RolesUsersInnerStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <RolesUsersInnerStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RolesUsersInnerStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [RolesUsersInnerStatusEnum] to String,
/// and [decode] dynamic data back to [RolesUsersInnerStatusEnum].
class RolesUsersInnerStatusEnumTypeTransformer {
  factory RolesUsersInnerStatusEnumTypeTransformer() => _instance ??= const RolesUsersInnerStatusEnumTypeTransformer._();

  const RolesUsersInnerStatusEnumTypeTransformer._();

  String encode(RolesUsersInnerStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a RolesUsersInnerStatusEnum.
  ///
  ...
  RolesUsersInnerStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return RolesUsersInnerStatusEnum.active;
        case r'invited': return RolesUsersInnerStatusEnum.invited;
        case r'draft': return RolesUsersInnerStatusEnum.draft;
        case r'suspended': return RolesUsersInnerStatusEnum.suspended;
        case r'deleted': return RolesUsersInnerStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [RolesUsersInnerStatusEnumTypeTransformer] instance.
  static RolesUsersInnerStatusEnumTypeTransformer? _instance;
}
