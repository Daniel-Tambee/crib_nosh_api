...
class AcceptInviteRequest {
  ...
  @override
  String toString() => 'AcceptInviteRequest[token=$token, password=$password]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AcceptInviteRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AcceptInviteRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
