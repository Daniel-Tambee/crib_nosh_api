...
class VersionsUserCreated {
  /// Returns a new [VersionsUserCreated] instance.
  VersionsUserCreated({
    this.id,
    this.firstName,
    this.lastName,
  ...
  /// Status of the user.
  VersionsUserCreatedStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VersionsUserCreated &&
    other.id == id &&
  ...
  /// Returns a new [VersionsUserCreated] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static VersionsUserCreated? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VersionsUserCreated[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VersionsUserCreated[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return VersionsUserCreated(
        ...
        status: VersionsUserCreatedStatusEnum.fromJson(json[r'status']),
  ...
  static List<VersionsUserCreated> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <VersionsUserCreated>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VersionsUserCreated.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, VersionsUserCreated> mapFromJson(dynamic json) {
    final map = <String, VersionsUserCreated>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = VersionsUserCreated.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of VersionsUserCreated-objects as value to a dart map
  static Map<String, List<VersionsUserCreated>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<VersionsUserCreated>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = VersionsUserCreated.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class VersionsUserCreatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const VersionsUserCreatedStatusEnum._(this.value);
  ...
  static const active = VersionsUserCreatedStatusEnum._(r'active');
  static const invited = VersionsUserCreatedStatusEnum._(r'invited');
  static const draft = VersionsUserCreatedStatusEnum._(r'draft');
  static const suspended = VersionsUserCreatedStatusEnum._(r'suspended');
  static const deleted = VersionsUserCreatedStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][VersionsUserCreatedStatusEnum].
  static const values = <VersionsUserCreatedStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static VersionsUserCreatedStatusEnum? fromJson(dynamic value) => VersionsUserCreatedStatusEnumTypeTransformer().decode(value);

  static List<VersionsUserCreatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <VersionsUserCreatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VersionsUserCreatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [VersionsUserCreatedStatusEnum] to String,
/// and [decode] dynamic data back to [VersionsUserCreatedStatusEnum].
class VersionsUserCreatedStatusEnumTypeTransformer {
  factory VersionsUserCreatedStatusEnumTypeTransformer() => _instance ??= const VersionsUserCreatedStatusEnumTypeTransformer._();

  const VersionsUserCreatedStatusEnumTypeTransformer._();

  String encode(VersionsUserCreatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a VersionsUserCreatedStatusEnum.
  ///
  ...
  VersionsUserCreatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return VersionsUserCreatedStatusEnum.active;
        case r'invited': return VersionsUserCreatedStatusEnum.invited;
        case r'draft': return VersionsUserCreatedStatusEnum.draft;
        case r'suspended': return VersionsUserCreatedStatusEnum.suspended;
        case r'deleted': return VersionsUserCreatedStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [VersionsUserCreatedStatusEnumTypeTransformer] instance.
  static VersionsUserCreatedStatusEnumTypeTransformer? _instance;
}
