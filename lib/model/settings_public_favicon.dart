...
class SettingsPublicFavicon {
  /// Returns a new [SettingsPublicFavicon] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SettingsPublicFavicon &&
    other.id == id &&
  ...
  @override
  String toString() => 'SettingsPublicFavicon[id=$id, storage=$storage, filenameDisk=$filenameDisk, filenameDownload=$filenameDownload, title=$title, type=$type, folder=$folder, uploadedBy=$uploadedBy, createdOn=$createdOn, modifiedBy=$modifiedBy, modifiedOn=$modifiedOn, charset=$charset, filesize=$filesize, width=$width, height=$height, duration=$duration, embed=$embed, description=$description, location=$location, tags=$tags, metadata=$metadata, focalPointX=$focalPointX, focalPointY=$focalPointY, tusId=$tusId, tusData=$tusData, uploadedOn=$uploadedOn]';
  ...
  /// Returns a new [SettingsPublicFavicon] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SettingsPublicFavicon? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SettingsPublicFavicon[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SettingsPublicFavicon[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SettingsPublicFavicon(
  ...
  static List<SettingsPublicFavicon> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SettingsPublicFavicon>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SettingsPublicFavicon.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SettingsPublicFavicon> mapFromJson(dynamic json) {
    final map = <String, SettingsPublicFavicon>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SettingsPublicFavicon.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SettingsPublicFavicon-objects as value to a dart map
  static Map<String, List<SettingsPublicFavicon>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SettingsPublicFavicon>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SettingsPublicFavicon.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
