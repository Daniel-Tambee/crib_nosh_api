...
class PresetsUser {
  /// Returns a new [PresetsUser] instance.
  PresetsUser({
    this.id,
    this.firstName,
    this.lastName,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PresetsUser &&
    other.id == id &&
  ...
  /// Returns a new [PresetsUser] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PresetsUser? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "PresetsUser[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "PresetsUser[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return PresetsUser(
        ...
        status: PresetsUserStatusEnum.fromJson(json[r'status']),
  ...
  static List<PresetsUser> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PresetsUser>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PresetsUser.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PresetsUser> mapFromJson(dynamic json) {
    final map = <String, PresetsUser>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PresetsUser.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of PresetsUser-objects as value to a dart map
  static Map<String, List<PresetsUser>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PresetsUser>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = PresetsUser.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class PresetsUserStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const PresetsUserStatusEnum._(this.value);
  ...
  static const active = PresetsUserStatusEnum._(r'active');
  static const invited = PresetsUserStatusEnum._(r'invited');
  static const draft = PresetsUserStatusEnum._(r'draft');
  static const suspended = PresetsUserStatusEnum._(r'suspended');
  static const deleted = PresetsUserStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][PresetsUserStatusEnum].
  static const values = <PresetsUserStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static PresetsUserStatusEnum? fromJson(dynamic value) => PresetsUserStatusEnumTypeTransformer().decode(value);

  static List<PresetsUserStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <PresetsUserStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PresetsUserStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [PresetsUserStatusEnum] to String,
/// and [decode] dynamic data back to [PresetsUserStatusEnum].
class PresetsUserStatusEnumTypeTransformer {
  factory PresetsUserStatusEnumTypeTransformer() => _instance ??= const PresetsUserStatusEnumTypeTransformer._();

  const PresetsUserStatusEnumTypeTransformer._();

  String encode(PresetsUserStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a PresetsUserStatusEnum.
  ///
  ...
  PresetsUserStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return PresetsUserStatusEnum.active;
        case r'invited': return PresetsUserStatusEnum.invited;
        case r'draft': return PresetsUserStatusEnum.draft;
        case r'suspended': return PresetsUserStatusEnum.suspended;
        case r'deleted': return PresetsUserStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [PresetsUserStatusEnumTypeTransformer] instance.
  static PresetsUserStatusEnumTypeTransformer? _instance;
}
