...
class CommentsUserCreated {
  /// Returns a new [CommentsUserCreated] instance.
  CommentsUserCreated({
    this.id,
    this.firstName,
    this.lastName,
  ...
  /// Status of the user.
  CommentsUserCreatedStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommentsUserCreated &&
    other.id == id &&
  ...
  /// Returns a new [CommentsUserCreated] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommentsUserCreated? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommentsUserCreated[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommentsUserCreated[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CommentsUserCreated(
        ...
        status: CommentsUserCreatedStatusEnum.fromJson(json[r'status']),
  ...
  static List<CommentsUserCreated> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommentsUserCreated>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentsUserCreated.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommentsUserCreated> mapFromJson(dynamic json) {
    final map = <String, CommentsUserCreated>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommentsUserCreated.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommentsUserCreated-objects as value to a dart map
  static Map<String, List<CommentsUserCreated>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommentsUserCreated>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CommentsUserCreated.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class CommentsUserCreatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const CommentsUserCreatedStatusEnum._(this.value);
  ...
  static const active = CommentsUserCreatedStatusEnum._(r'active');
  static const invited = CommentsUserCreatedStatusEnum._(r'invited');
  static const draft = CommentsUserCreatedStatusEnum._(r'draft');
  static const suspended = CommentsUserCreatedStatusEnum._(r'suspended');
  static const deleted = CommentsUserCreatedStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][CommentsUserCreatedStatusEnum].
  static const values = <CommentsUserCreatedStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static CommentsUserCreatedStatusEnum? fromJson(dynamic value) => CommentsUserCreatedStatusEnumTypeTransformer().decode(value);

  static List<CommentsUserCreatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommentsUserCreatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentsUserCreatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CommentsUserCreatedStatusEnum] to String,
/// and [decode] dynamic data back to [CommentsUserCreatedStatusEnum].
class CommentsUserCreatedStatusEnumTypeTransformer {
  factory CommentsUserCreatedStatusEnumTypeTransformer() => _instance ??= const CommentsUserCreatedStatusEnumTypeTransformer._();

  const CommentsUserCreatedStatusEnumTypeTransformer._();

  String encode(CommentsUserCreatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CommentsUserCreatedStatusEnum.
  ///
  ...
  CommentsUserCreatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return CommentsUserCreatedStatusEnum.active;
        case r'invited': return CommentsUserCreatedStatusEnum.invited;
        case r'draft': return CommentsUserCreatedStatusEnum.draft;
        case r'suspended': return CommentsUserCreatedStatusEnum.suspended;
        case r'deleted': return CommentsUserCreatedStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [CommentsUserCreatedStatusEnumTypeTransformer] instance.
  static CommentsUserCreatedStatusEnumTypeTransformer? _instance;
}
