...
class FlowsUserCreated {
  /// Returns a new [FlowsUserCreated] instance.
  FlowsUserCreated({
    this.id,
    this.firstName,
    this.lastName,
  ...
  /// Status of the user.
  FlowsUserCreatedStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FlowsUserCreated &&
    other.id == id &&
  ...
  /// Returns a new [FlowsUserCreated] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FlowsUserCreated? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FlowsUserCreated[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FlowsUserCreated[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FlowsUserCreated(
        ...
        status: FlowsUserCreatedStatusEnum.fromJson(json[r'status']),
  ...
  static List<FlowsUserCreated> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FlowsUserCreated>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FlowsUserCreated.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FlowsUserCreated> mapFromJson(dynamic json) {
    final map = <String, FlowsUserCreated>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FlowsUserCreated.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FlowsUserCreated-objects as value to a dart map
  static Map<String, List<FlowsUserCreated>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FlowsUserCreated>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FlowsUserCreated.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class FlowsUserCreatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const FlowsUserCreatedStatusEnum._(this.value);
  ...
  static const active = FlowsUserCreatedStatusEnum._(r'active');
  static const invited = FlowsUserCreatedStatusEnum._(r'invited');
  static const draft = FlowsUserCreatedStatusEnum._(r'draft');
  static const suspended = FlowsUserCreatedStatusEnum._(r'suspended');
  static const deleted = FlowsUserCreatedStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][FlowsUserCreatedStatusEnum].
  static const values = <FlowsUserCreatedStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static FlowsUserCreatedStatusEnum? fromJson(dynamic value) => FlowsUserCreatedStatusEnumTypeTransformer().decode(value);

  static List<FlowsUserCreatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FlowsUserCreatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FlowsUserCreatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [FlowsUserCreatedStatusEnum] to String,
/// and [decode] dynamic data back to [FlowsUserCreatedStatusEnum].
class FlowsUserCreatedStatusEnumTypeTransformer {
  factory FlowsUserCreatedStatusEnumTypeTransformer() => _instance ??= const FlowsUserCreatedStatusEnumTypeTransformer._();

  const FlowsUserCreatedStatusEnumTypeTransformer._();

  String encode(FlowsUserCreatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a FlowsUserCreatedStatusEnum.
  ///
  ...
  FlowsUserCreatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return FlowsUserCreatedStatusEnum.active;
        case r'invited': return FlowsUserCreatedStatusEnum.invited;
        case r'draft': return FlowsUserCreatedStatusEnum.draft;
        case r'suspended': return FlowsUserCreatedStatusEnum.suspended;
        case r'deleted': return FlowsUserCreatedStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [FlowsUserCreatedStatusEnumTypeTransformer] instance.
  static FlowsUserCreatedStatusEnumTypeTransformer? _instance;
}
