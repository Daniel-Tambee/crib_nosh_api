...
class CommentsUserUpdated {
  /// Returns a new [CommentsUserUpdated] instance.
  CommentsUserUpdated({
    this.id,
    this.firstName,
    this.lastName,
  ...
  /// Status of the user.
  CommentsUserUpdatedStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CommentsUserUpdated &&
    other.id == id &&
  ...
  /// Returns a new [CommentsUserUpdated] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CommentsUserUpdated? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CommentsUserUpdated[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CommentsUserUpdated[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CommentsUserUpdated(
        ...
        status: CommentsUserUpdatedStatusEnum.fromJson(json[r'status']),
  ...
  static List<CommentsUserUpdated> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommentsUserUpdated>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentsUserUpdated.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CommentsUserUpdated> mapFromJson(dynamic json) {
    final map = <String, CommentsUserUpdated>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CommentsUserUpdated.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CommentsUserUpdated-objects as value to a dart map
  static Map<String, List<CommentsUserUpdated>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CommentsUserUpdated>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CommentsUserUpdated.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class CommentsUserUpdatedStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const CommentsUserUpdatedStatusEnum._(this.value);
  ...
  static const active = CommentsUserUpdatedStatusEnum._(r'active');
  static const invited = CommentsUserUpdatedStatusEnum._(r'invited');
  static const draft = CommentsUserUpdatedStatusEnum._(r'draft');
  static const suspended = CommentsUserUpdatedStatusEnum._(r'suspended');
  static const deleted = CommentsUserUpdatedStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][CommentsUserUpdatedStatusEnum].
  static const values = <CommentsUserUpdatedStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static CommentsUserUpdatedStatusEnum? fromJson(dynamic value) => CommentsUserUpdatedStatusEnumTypeTransformer().decode(value);

  static List<CommentsUserUpdatedStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CommentsUserUpdatedStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CommentsUserUpdatedStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [CommentsUserUpdatedStatusEnum] to String,
/// and [decode] dynamic data back to [CommentsUserUpdatedStatusEnum].
class CommentsUserUpdatedStatusEnumTypeTransformer {
  factory CommentsUserUpdatedStatusEnumTypeTransformer() => _instance ??= const CommentsUserUpdatedStatusEnumTypeTransformer._();

  const CommentsUserUpdatedStatusEnumTypeTransformer._();

  String encode(CommentsUserUpdatedStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a CommentsUserUpdatedStatusEnum.
  ///
  ...
  CommentsUserUpdatedStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return CommentsUserUpdatedStatusEnum.active;
        case r'invited': return CommentsUserUpdatedStatusEnum.invited;
        case r'draft': return CommentsUserUpdatedStatusEnum.draft;
        case r'suspended': return CommentsUserUpdatedStatusEnum.suspended;
        case r'deleted': return CommentsUserUpdatedStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [CommentsUserUpdatedStatusEnumTypeTransformer] instance.
  static CommentsUserUpdatedStatusEnumTypeTransformer? _instance;
}
