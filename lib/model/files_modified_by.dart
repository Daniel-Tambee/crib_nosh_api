...
class FilesModifiedBy {
  /// Returns a new [FilesModifiedBy] instance.
  FilesModifiedBy({
    this.id,
    this.firstName,
    this.lastName,
  ...
  /// Status of the user.
  FilesModifiedByStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FilesModifiedBy &&
    other.id == id &&
  ...
  /// Returns a new [FilesModifiedBy] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FilesModifiedBy? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FilesModifiedBy[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FilesModifiedBy[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FilesModifiedBy(
        ...
        status: FilesModifiedByStatusEnum.fromJson(json[r'status']),
  ...
  static List<FilesModifiedBy> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FilesModifiedBy>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FilesModifiedBy.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FilesModifiedBy> mapFromJson(dynamic json) {
    final map = <String, FilesModifiedBy>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FilesModifiedBy.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FilesModifiedBy-objects as value to a dart map
  static Map<String, List<FilesModifiedBy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FilesModifiedBy>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FilesModifiedBy.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class FilesModifiedByStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const FilesModifiedByStatusEnum._(this.value);
  ...
  static const active = FilesModifiedByStatusEnum._(r'active');
  static const invited = FilesModifiedByStatusEnum._(r'invited');
  static const draft = FilesModifiedByStatusEnum._(r'draft');
  static const suspended = FilesModifiedByStatusEnum._(r'suspended');
  static const deleted = FilesModifiedByStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][FilesModifiedByStatusEnum].
  static const values = <FilesModifiedByStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static FilesModifiedByStatusEnum? fromJson(dynamic value) => FilesModifiedByStatusEnumTypeTransformer().decode(value);

  static List<FilesModifiedByStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FilesModifiedByStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FilesModifiedByStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [FilesModifiedByStatusEnum] to String,
/// and [decode] dynamic data back to [FilesModifiedByStatusEnum].
class FilesModifiedByStatusEnumTypeTransformer {
  factory FilesModifiedByStatusEnumTypeTransformer() => _instance ??= const FilesModifiedByStatusEnumTypeTransformer._();

  const FilesModifiedByStatusEnumTypeTransformer._();

  String encode(FilesModifiedByStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a FilesModifiedByStatusEnum.
  ///
  ...
  FilesModifiedByStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return FilesModifiedByStatusEnum.active;
        case r'invited': return FilesModifiedByStatusEnum.invited;
        case r'draft': return FilesModifiedByStatusEnum.draft;
        case r'suspended': return FilesModifiedByStatusEnum.suspended;
        case r'deleted': return FilesModifiedByStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [FilesModifiedByStatusEnumTypeTransformer] instance.
  static FilesModifiedByStatusEnumTypeTransformer? _instance;
}
