...
class FilesUploadedBy {
  /// Returns a new [FilesUploadedBy] instance.
  FilesUploadedBy({
    this.id,
    this.firstName,
    this.lastName,
  ...
  /// Status of the user.
  FilesUploadedByStatusEnum? status;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FilesUploadedBy &&
    other.id == id &&
  ...
  /// Returns a new [FilesUploadedBy] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FilesUploadedBy? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FilesUploadedBy[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FilesUploadedBy[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return FilesUploadedBy(
        ...
        status: FilesUploadedByStatusEnum.fromJson(json[r'status']),
  ...
  static List<FilesUploadedBy> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FilesUploadedBy>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FilesUploadedBy.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FilesUploadedBy> mapFromJson(dynamic json) {
    final map = <String, FilesUploadedBy>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FilesUploadedBy.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FilesUploadedBy-objects as value to a dart map
  static Map<String, List<FilesUploadedBy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FilesUploadedBy>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FilesUploadedBy.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
/// Status of the user.
class FilesUploadedByStatusEnum {
  /// Instantiate a new enum with the provided [value].
  const FilesUploadedByStatusEnum._(this.value);
  ...
  static const active = FilesUploadedByStatusEnum._(r'active');
  static const invited = FilesUploadedByStatusEnum._(r'invited');
  static const draft = FilesUploadedByStatusEnum._(r'draft');
  static const suspended = FilesUploadedByStatusEnum._(r'suspended');
  static const deleted = FilesUploadedByStatusEnum._(r'deleted');

  /// List of all possible values in this [enum][FilesUploadedByStatusEnum].
  static const values = <FilesUploadedByStatusEnum>[
    active,
    invited,
    draft,
    suspended,
  ...
  static FilesUploadedByStatusEnum? fromJson(dynamic value) => FilesUploadedByStatusEnumTypeTransformer().decode(value);

  static List<FilesUploadedByStatusEnum> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FilesUploadedByStatusEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FilesUploadedByStatusEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
/// Transformation class that can [encode] an instance of [FilesUploadedByStatusEnum] to String,
/// and [decode] dynamic data back to [FilesUploadedByStatusEnum].
class FilesUploadedByStatusEnumTypeTransformer {
  factory FilesUploadedByStatusEnumTypeTransformer() => _instance ??= const FilesUploadedByStatusEnumTypeTransformer._();

  const FilesUploadedByStatusEnumTypeTransformer._();

  String encode(FilesUploadedByStatusEnum data) => data.value;

  /// Decodes a [dynamic value][data] to a FilesUploadedByStatusEnum.
  ///
  ...
  FilesUploadedByStatusEnum? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'active': return FilesUploadedByStatusEnum.active;
        case r'invited': return FilesUploadedByStatusEnum.invited;
        case r'draft': return FilesUploadedByStatusEnum.draft;
        case r'suspended': return FilesUploadedByStatusEnum.suspended;
        case r'deleted': return FilesUploadedByStatusEnum.deleted;
        default:
          if (!allowNull) {
  ...
  /// Singleton [FilesUploadedByStatusEnumTypeTransformer] instance.
  static FilesUploadedByStatusEnumTypeTransformer? _instance;
}
