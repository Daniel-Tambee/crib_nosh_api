...
class Files {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Files &&
    other.id == id &&
  ...
  @override
  String toString() => 'Files[id=$id, storage=$storage, filenameDisk=$filenameDisk, filenameDownload=$filenameDownload, title=$title, type=$type, folder=$folder, uploadedBy=$uploadedBy, createdOn=$createdOn, modifiedBy=$modifiedBy, modifiedOn=$modifiedOn, charset=$charset, filesize=$filesize, width=$width, height=$height, duration=$duration, embed=$embed, description=$description, location=$location, tags=$tags, metadata=$metadata, focalPointX=$focalPointX, focalPointY=$focalPointY, tusId=$tusId, tusData=$tusData, uploadedOn=$uploadedOn]';
  ...
  /// Returns a new [Files] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Files? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Files[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Files[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Files> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Files>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Files.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Files> mapFromJson(dynamic json) {
    final map = <String, Files>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Files.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of Files-objects as value to a dart map
  static Map<String, List<Files>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Files>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Files.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
