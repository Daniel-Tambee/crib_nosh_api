...
void main() {
  ...
  group('test CreatePermissionRequest', () {
    ...
    // String explain
    test('to test the property `explain`', () async {
      // TODO
    });
    ...
    // List<String> readFieldBlacklist (default value: const [])
    test('to test the property `readFieldBlacklist`', () async {
      // TODO
    });
    ...
    // List<String> statusBlacklist (default value: const [])
    test('to test the property `statusBlacklist`', () async {
      // TODO
    });
    ...
    // List<String> writeFieldBlacklist (default value: const [])
    test('to test the property `writeFieldBlacklist`', () async {
      // TODO
    });
