...
/// tests for ItemsChefProfileApi
void main() {
  // final instance = ItemsChefProfileApi();

  group('tests for ItemsChefProfileApi', () {
    // Create an Item
    //
    ...
    //
    //FutureOr deleteItemsChefProfile() async
    ...
    //
    //FutureOr deleteSingleItemsChefProfile(ReadSingleItemsCuisineIdParameter id) async
