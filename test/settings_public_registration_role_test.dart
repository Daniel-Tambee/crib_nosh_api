...
// tests for SettingsPublicRegistrationRole
void main() {
  // final instance = SettingsPublicRegistrationRole();

  group('test SettingsPublicRegistrationRole', () {
    ...
    // List<RolesChildrenInner> children (default value: const [])
    ...
    // List<RolesUsersInner> users (default value: const [])
