...
// tests for OperationsUserCreated
void main() {
  // final instance = OperationsUserCreated();

  group('test OperationsUserCreated', () {
    ...
    // String tfaSecret
    test('to test the property `tfaSecret`', () async {
      // TODO
    });
    ...
    // DateTime lastAccess
    test('to test the property `lastAccess`', () async {
      // TODO
    });
    ...
    // String themeDark
    test('to test the property `themeDark`', () async {
      // TODO
    });

    // String themeLight
    test('to test the property `themeLight`', () async {
      // TODO
    });
