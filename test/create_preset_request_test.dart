...
// tests for CreatePresetRequest
void main() {
  // final instance = CreatePresetRequest();

  group('test CreatePresetRequest', () {
    ...
    // List<CreatePresetRequestFiltersInner> filters (default value: const [])
