...
// tests for UpdatePresetRequest
void main() {
  // final instance = UpdatePresetRequest();

  group('test UpdatePresetRequest', () {
    ...
    // List<UpdatePresetRequestFiltersInner> filters (default value: const [])
    ...
    // String viewQuery
    test('to test the property `viewQuery`', () async {
      // TODO
    });

    // Options of the views. The properties in here are controlled by the layout.
    // String viewOptions
    test('to test the property `viewOptions`', () async {
      // TODO
    });
