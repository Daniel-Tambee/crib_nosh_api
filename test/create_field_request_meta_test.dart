...
// tests for CreateFieldRequestMeta
void main() {
  // final instance = CreateFieldRequestMeta();

  group('test CreateFieldRequestMeta', () {
    ...
    // List<String> special (default value: const [])
    ...
    test('to test the property `systemInterface`', () async {
      // TODO
    });
    ...
    test('to test the property `displayOptions`', () async {
      // TODO
    });
